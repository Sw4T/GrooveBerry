...
public class ReadingQueue implements AudioListener, Serializable {
	...
	public ArrayList<String> getAllSongsNames() {
		ArrayList<String> songsNames = new ArrayList<String>();
		for (AudioFile file : this.getAudioFileList()) {
	...
	public String[] convertToStringTab() {
		String[] list = this.getAllSongsNames().toArray(new String[this.getAllSongsNames().size()]);
