...
public class Client implements Runnable {
	...
	private Socket socketSimple; //Socket utilis� pour communiquer avec le client
	private Socket socketFile; //Socket utilis� pour communiquer avec le client
	...
	protected AtomicBoolean connect; //Bool�en assurant que le client est connecté
	private Server server; //R�f�rence au serveur principal
	...
	public void run() {
		while (connect.get()) { //Tant que la connexion est active
			try {
				...
				Object [] toSend = new Object[2]; //Objets allant �tre envoy� aux clients
				...
				new Thread(threadNotifier).start(); //Envoi � tous les clients du changement d'�tat du serveur
	...
	/**
	 * R�cup�re une constante de traitement du client connect� afin de changer l'�tat du serveur/du fil de lecture.
	 */
	 ...
	 * @param constant
	 * 		Constante de traitement allant �tre ex�cut�e
	 * @return
	 * 		Le protocole correspondant au traitement effectu�
	 */
